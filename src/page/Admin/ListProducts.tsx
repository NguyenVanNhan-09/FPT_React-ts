   ...
   return (
      <>
         <div className="text-center p-10">
            <h1 className="font-bold text-4xl mb-4 ">List Products</h1>
         </div>
         <a
            href="/admin/products-add"
            className="inline-flex mb-4 mt-4 align-middle select-none font-sans font-bold text-center uppercase transition-all disabled:opacity-50 disabled:shadow-none disabled:pointer-events-none text-xs py-3 px-6 rounded-lg bg-gray-900 text-white shadow-md shadow-gray-900/10 hover:shadow-lg hover:shadow-gray-900/20 focus:opacity-[0.85] focus:shadow-none active:opacity-[0.85] active:shadow-none items-center gap-3"
            type="button"
         >
            <svg
                        ...
                        <tbody className="divide-y divide-gray-300 ">
                           {products.map((item: TProduct) => (
                              <tr className="bg-white transition-all duration-500 hover:bg-gray-50">
                                 ...
                                 <td className="p-5 whitespace-nowrap text-sm leading-6 font-medium text-gray-900 overflow-hidden text-ellipsis max-w-48">
                                    {item.title}
                                 </td>
                                 ...
                                 <td className=" px-5 py-3">
                                    <div className="whitespace-nowrap text-sm leading-6 font-medium text-gray-900">
                                       <img
