...
export default function Example({ change, setChange }: Props) {
   const navi = useNavigate();
   const { cartItems, cartQty, removeCartItem, totalPrice } =
      useContext(cartCT);
   console.log(cartQty);
   return (
      <>
                                 ...
                                 <button
                                    onClick={() => {
                                       if (cartItems.length === 0) {
                                          toast.error(
                                             "Không có sản phẩm trong giỏ hàng không thể thanh toán",
                                             {
                                                position: "top-center",
                                                autoClose: 2000,
