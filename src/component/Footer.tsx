const Footer = () => {
   return (
      <>
         <footer className="bg-[#053D29] dark:bg-[#053D29]">
            ...
            <div className="mx-auto w-full bg-[#062F21]">
               <div className="sm:flex sm:items-center sm:justify-between max-w-screen-xl mx-auto py-3">
                  <span className="text-[11.71px] text-white sm:text-center dark:text-gray-400">
                     2023 hood.de , Inc.
                  </span>
